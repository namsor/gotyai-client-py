...
# Path params
LoggerSchema = schemas.StrSchema
LevelSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'logger': typing.Union[LoggerSchema, str, ],
...
request_path_logger = api_client.PathParameter(
    name="logger",
