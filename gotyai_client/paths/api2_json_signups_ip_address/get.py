...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'ipAddress': typing.Union[IpAddressSchema, str, ],
    }
)
...
request_path_ip_address = api_client.PathParameter(
    name="ipAddress",
