...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'displayName': typing.Union[DisplayNameSchema, str, ],
...
request_path_display_name = api_client.PathParameter(
    name="displayName",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationJson = UserInfoOut
...
class UpdateUserInfo(BaseApi):
    ...
    def update_user_info(
        ...
        return self._update_user_info_oapg(
