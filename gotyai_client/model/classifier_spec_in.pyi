...
class ClassifierSpecIn(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["categories", "classifierName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["categories", "classifierName", ], str]):
