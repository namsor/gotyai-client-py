...
from gotyai_client.paths.api2_json_resend_key_token_recaptchav2 import get  # noqa: E501
from gotyai_client import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApi2JsonResendKeyTokenRecaptchav2(ApiTestMixin, unittest.TestCase):
    """
    Api2JsonResendKeyTokenRecaptchav2 unit test stubs
