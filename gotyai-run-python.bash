...
java -jar modules/openapi-generator-cli/target/openapi-generator-cli.jar generate  --git-repo-id gotyai-client-py --git-user-id namsor --skip-validate-spec -i http://ns3044521.ip-91-121-222.eu:8080/gotyai/api2/openapi.json -g python -o  gotyai/client/python  --additional-properties packageVersion=3.0.2 --additional-properties packageName=gotyai_client
...
cp -R /home/namsor/codegen/openapi-generator/gotyai/client/python/* /home/namsor/codegen/gotyai-client-py/
cp /home/namsor/codegen/openapi-generator/gotyai-run-python.bash /home/namsor/codegen/gotyai-client-py/
