...
class SpamEventOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "timestamp", ], str]):
