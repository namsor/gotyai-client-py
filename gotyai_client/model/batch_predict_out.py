        ...
        class properties:
            ...
            class rows(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PredictOut']:
                        return PredictOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PredictOut'], typing.List['PredictOut']],
                ...
                def __getitem__(self, i: int) -> 'PredictOut':
